...
WW_LIST = [
    # ::FC ::TO
    (19,'Tornado (Windhose), Trichterwolke','funnel clouds (tornado)',None,'tornado.png','18.png','','::FC'),
    # 95...99 thunderstorm at time of observation
    (99,'schweres Gewitter mit Hagel','heavy thunderstorm with hail',None,'thunderstorm.png','30.png','tstorm',':H:T'),
    (98,'Gewitter mit Staub- oder Standsturm','thunderstorm with duststorm or sandstorm',None,'thunderstorm.png','27.png','tstorm','::T'),
    (97,'schweres Gewitter mit Regen oder Schnee','heavy thunderstorm with rain or snow',None,'thunderstorm.png','28.png','tstorm',':H:T'),
    (96,'leichtes oder mäßiges Gewitter mit Hagel','slight or moderate thunderstorm with hail',None,'thunderstorm.png','29.png','tstorm',':L:T'),
    (95,'leichtes oder mäßiges Gewitter mit Regen oder Schnee','slight or moderate thunderstorm with rain or snow',1,'thunderstorm.png','27.png','tstorm',':L:T'),
    ...
    (24,'nach gefrierendem Regen','after freezing drizzle or freezing rain',None,'rain.png','66.png','freezingrain','::ZR'),
    # 80...90 shower(s) or precipitation with current or recent thunderstorm
    (90,'kräftige Hagelschauer','moderate or heavy shower(s) of hail',None,'hail.png','17.png','hail',':H:A'),
    ...
    (92,'kräftiger Regen nach Gewitter','moderate or heavy rain after thunderstorm',None,'rain.png','27.png','rain',':H:T'),
    (91,'leichter Regen nach Gewitter','slight rain after thunderstorm',None,'rain.png','27.png','rain',':L:T'),
    # 80...90 shower(s) or precipitation with current or recent thunderstorm
    ...
    (74,'intermittierend starker Schneefall','heavy snowfall, intermittent',None,'snow.png','16.png','snow','IN:H:S'),
    (73,'durchgehend mäßiger Schneefall','moderate snowfall, continuous',14,'snow.png','15.png','snow','::S'),
    (72,'intermittierend mäßiger Schneefall','moderate snowfall, intermittent',None,'snow.png','15.png','snow','IN::S'),
    (71,'durchgehend leichter Schneefall','slight snowfall, continuous',15,'snow.png','14.png','snow',':L:S'),
    (70,'intermittierend leichter Schneefall','slight snowfall, intermittent',None,'snow.png','14.png','snow','IN:L:S'),
    # 60...69 rain
    (69,'mäßger oder starker Schneeregen','moderate or heavy rain and snow',16,'sleet.png','13.png','rainandsnow',':H:RS'),
    (68,'leichter Schneeregen','slight rain and snow',17,'sleet.png','12.png','rainandsnow',':L:RS'),
    # 50...59 drizzle
    (59,'starker Sprühregen und Regen','moderate or heavy drizzle and rain',None,'rain.png','','rain',''),
    (58,'leichter Sprühregen und Regen','slight drizzle and rain',None,'rain.png','','rain',''),
    (55,'durchgehend starker Sprühregen','heavy drizzle, not freezing, continuous',18,'drizzle.png','9.png','drizzle',':H:L'),
    (54,'intermittierend starker Sprühregen','heavy drizzle, not freezing, intermittent',None,'drizzle.png','9.png','drizzle','IN:H:L'),
    (53,'durchgehend mäßiger Sprühregen','moderate drizzle, not freezing, continuous',19,'drizzle.png','8.png','drizzle','::L'),
    (52,'intermittierend mäßiger Sprühregen','moderate drizzle, not freezing, intermittent',None,'drizzle.png','8.png','drizzle','IN::L'),
    (51,'durchgehend leichter Sprühregen','slight drizzle, not freezing, continuous',20,'drizzle.png','7.png','drizzle',':L:L'),
    (50,'intermittierend leichter Sprühregen','slight drizzle, not freezing, intermittent',None,'drizzle.png','7.png','drizzle','IN:L:L'),
    # 60...69 rain
    (65,'durchgehend starker Regen','heavy rain, not freezing, continuous',21,'rain.png','9.png','rain',':H:R'),
    (64,'intermittierend starker Regen','heavy rain, not freezing, intermittent',None,'rain.png','9.png','rain','IN:H:R'),
    ...
    (48,'Nebel mit Reifansatz, Himmel erkennbar','fog depositing rime, sky visible',None,'fog.png','48.png','fog','::IF'),
    (47,'Nebel oder Eisnebel, Himmel nicht erkennbar, zunehmend','fog or ice fog, sky invisible, has become thicker',None,'fog.png','48.png','fog','::IF'),
    (46,'Nebel oder Eisnebel, Himmel erkennbar, zunehmend','fog or ice fog, sky visible, has become thicker',None,'fog.png','48.png','fog','::IF'),
    # 45 in MOSMIX
    ...
    (44,'Nebel oder Eisnebel, Himmel erkennbar, unverändert','fog or ice fog, sky visible, no change',None,'fog.png','40.png','fog','::F'), 
    (43,'Nebel oder Eisnebel, Himmel nicht erkennbar, abnehmend','fog or ice fog, sky invisible, has become thinner',None,'fog.png','40.png','fog','::F'),
    (42,'Nebel oder Eisnebel, Himmel erkennbar, abnehmend','fog or ice fog, sky visible, has become thinner',None,'fog.png','40.png','fog','::F'),
    (41,'stellenweise Nebel oder Eisnebel','fog or ice fog in patches',None,'fog.png','40.png','fog','PA::F'),
    (40,'Nebel oder Eisnebel in der Entfernung','fog or ice fog at a distance',None,'fog.png','40.png','fog','VC::F'),
    
    # duststorm, sandstorm, drifting or blowing snow
    # 39 heavy drifting snow, generally high (above eye level) :H:BS
    (39,'starkes Schneefegen, oberhalb Augenhöhe','heavy drifting snow, generally high (above eye level)',None,'wind.png','18.png','blowingsnow',':H:BS'),
    # 38 slight or moderate blowing snow, generally high (above eye level) :L:BS
    (38,'Schneefegen, oberhalb Augenhöhe','slight or moderate blowing snow, generally high (above eye level)',None,'wind.png','18.png','blowingsnow',':L:BS'),
    # 37 heavy drifting snow, generally low (below eye level) :H:BS
    (37,'starkes Schneefegen unterhalb Augenhöhe','heavy drifting snow, generally low (below eye level',None,'wind.png','18.png','blowingsnow',':H:BS'),
    # 36 slight or moderate blowing snow, generally low (below eye level) :L:BS
    (36,'Schneefegen unterhalb Augenhöhe','slight or moderate blowing snow, generally low (below eye level)',None,'wind.png','18.png','blowingsnow',':L:BS'),
    # 35 severe duststorm or sandstorm, increasing
    (35,'schwerer Staub- oder Sandsturm, zunehmend','severe duststorm or sandstorm, increasing',None,'wind.png','18.png','wind',':H:BD'),
    # 34 severe duststorm or sandstorm, no change :H:BD :H:BN
    (34,'schwerer Staub- oder Sandsturm, unverändert','severe duststorm or sandstorm, no change',None,'wind.png','18.png','wind',':H:BD'),
    # 33 severe duststorm or sandstorm, decreasing
    (33,'schwerer Staub- oder Sandsturm, abnehmend','severe duststorm or sandstorm, decreasing',None,'wind.png','18.png','wind',':H:BD'),
    # 32 slight or moderate duststorm or sandstorm, increasing
    (32,'leichter oder mittlerer Staub- oder Sandsturm, zunehmend','slight or moderate duststorm or sandstorm, increasing',None,'wind.png','18.png','wind',':L:BD'),
    ...
    (4,'durch Rauch oder Vulkanasche eingeschränkte Sicht','visbility reduced by smoke or volcanic ashes',None,'fog.png','40.png','smoke','::K'),
...
WW_SYMBOLS = [
    ...
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 10-19 General Group: No precipitation at the station at the time of observation or, except 17, during the preceeding hour. 	Code: 10 	Description: Mist </desc> <g id="ww_10" fill="none" stroke-width="3" stroke="#ffc83f"> 	<path d="M -17.5,-4.5 h 35 M -17.5,4.5 h 35" /> </g> </svg> ',
    # 11 https://upload.wikimedia.org/wikipedia/commons/f/f7/Symbol_code_ww_11.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 10-19 General Group: No precipitation at the station at the time of observation or, except 17, during the preceeding hour. 	Code: 11 	Description: Patches of shallow fog at station, NOT deeper than 6 feet on land </desc> <g id="ww_11" fill="none" stroke-width="3" stroke="#ffc83f" > 	<path d="M -17.5,-9.5 h 14.5 M 17.5,-9.5 h -14.5 M -17.5,0 h 14.5 M 17.5,0 h -14.5 M -17.5,9.5 h 14.5 M 17.5,9.5 h -14.5" /> </g> </svg> ',
    # 12 https://upload.wikimedia.org/wikipedia/commons/0/03/Symbol_code_ww_12.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 10-19 General Group: No precipitation at the station at the time of observation or, except 17, during the preceeding hour. 	Code: 12 	Description: More or less continuous shallow fog at station, NOT deeper than 6 feet on land </desc> <g id="ww_12" fill="none" stroke-width="3" stroke="#ffc83f"> 	<path d="M -17.5,-9.5 h 14.5 M 17.5,-9.5 h -14.5 M -17.5,9.5 h 35 M -17.5,0 h 14.5 M 17.5,0 h -14.5" /> </g> </svg> ',
    ...
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 10-19 General Group: No precipitation at the station at the time of observation or, except 17, during the preceeding hour. 	Code: 18 	Description: Squall(s) within sight during past hour </desc> <g id="ww_18" fill="none" stroke-width="3" stroke="#000000" stroke-miterlimit="2.5" > 	<path d="M 0,-11 l 16,-7.5 l -16,36 l -16,-36 l 16,7.5 z"/> </g> </svg> ',
    # 19 https://upload.wikimedia.org/wikipedia/commons/9/9c/Symbol_code_ww_19.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 10-19 General Group: No precipitation at the station at the time of observation or, except 17, during the preceeding hour. 	Code: 19 	Description: Funnel cloud(s) / Tornado(s) during the preceding hour or at time of observation </desc> <g id="ww_19" fill="none" stroke-width="3" stroke="#000000" > 	<path d="M -11.5,-20.5 l 8,7 v 27 l -8,7 M 11.5,-20.5 l -8,7 v 27 l 8,7"/> </g> </svg> ',
    # 20 https://upload.wikimedia.org/wikipedia/commons/d/da/Symbol_code_ww_20.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 20-29 General Group: Precipitation, fog, ice fog, or thunderstorm at the station during the preceeding hour but not at the time of observation. 	Code: 20 	Description: Drizzle (not freezing) or snow grains not falling as shower(s) ended in the past hour </desc> <g id="ww_20"> <circle r="5.5" cx="-4" fill="#00d700" /> <path style="fill:none; stroke:#00d700; stroke-width:3; stroke-linecap:round;" d="M 0,0 C 0,3.7 -2.1,7.1 -5,9.2" /> <path d="M 1,-21 h 7 v42 h-7" fill="none" stroke-width="3" stroke="#000000" /> </g> </svg> ',
    ...
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 81 	Description: Rain shower(s), moderate or heavy </desc> <g id="ww_81"> 	<circle r="5.5" cy="-15.5" fill="#00d700" /> 	<path d="M 0,-5.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#00d700" /> 	<path d="M -6,0.5 h 12" style="fill:none; stroke-width:3; stroke:#00d700" /> </g> </svg> ',
    # 82 https://upload.wikimedia.org/wikipedia/commons/a/a7/Symbol_code_ww_82.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 82 	Description: Rain shower(s), violent </desc> <g id="ww_82"> 	<circle r="5.5" cy="-20.5" fill="#00d700" /> 	<circle r="5.5" cy="-8" fill="#00d700" /> 	<path d="M 0,0.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#00d700" /> </g> </svg> ',
    # 83 https://upload.wikimedia.org/wikipedia/commons/6/6b/Symbol_code_ww_83.svg
    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 83 	Description: Shower(s) of rain and snow mixed, slight </desc> <g id="ww_83"> 	<circle r="5.5" cy="-20.5" fill="#00d700" /> 	<g transform="translate(0,-8)"> 	<path id="ww83arm" d="M -5.5,0 h11" stroke="#ac00ff" stroke-linecap="round" stroke-width="3" /> 	<use xlink:href="#ww83arm" transform="rotate(60)" /> 	<use xlink:href="#ww83arm" transform="rotate(120)" /> 	</g> 	<path d="M 0,0.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#00d700" /> </g> </svg> ',
    # 84 https://upload.wikimedia.org/wikipedia/commons/d/d2/Symbol_code_ww_84.svg
    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 84 	Description: Shower(s) of rain and snow mixed, moderate or heavy </desc> <g id="ww_84"> 	<circle r="5.5" cy="-20.5" fill="#00d700" /> 	<g transform="translate(0,-8)"> 	<path id="ww84arm" d="M -5.5,0 h11" stroke="#ac00ff" stroke-linecap="round" stroke-width="3" /> 	<use xlink:href="#ww84arm" transform="rotate(60)" /> 	<use xlink:href="#ww84arm" transform="rotate(120)" /> 	</g> 	<path d="M 0,0.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#00d700" /> 	<path d="M -6,6.5 h 12" style="fill:none; stroke-width:3; stroke:#00d700" /> </g> </svg> ',
    # 85 https://upload.wikimedia.org/wikipedia/commons/3/3f/Symbol_code_ww_85.svg
    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 85 	Description: Snow shower(s), slight </desc> <g id="ww_85"> 	<g transform="translate(0,-15.5)"> 	<path id="ww85arm" d="M -5.5,0 h11" stroke="#ac00ff" stroke-linecap="round" stroke-width="3" /> 	<use xlink:href="#ww85arm" transform="rotate(60)" /> 	<use xlink:href="#ww85arm" transform="rotate(120)" /> 	</g> 	<path d="M 0,-5.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#ac00ff" /> </g> </svg> ',
    # 86 https://upload.wikimedia.org/wikipedia/commons/c/c4/Symbol_code_ww_86.svg
    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 86 	Description: Snow shower(s), moderate or heavy </desc> <g id="ww_86"> 	<g transform="translate(0,-15.5)"> 	<path id="ww86arm" d="M -5.5,0 h11" stroke="#ac00ff" stroke-linecap="round" stroke-width="3" /> 	<use xlink:href="#ww86arm" transform="rotate(60)" /> 	<use xlink:href="#ww86arm" transform="rotate(120)" /> 	</g> 	<path d="M 0,-5.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#ac00ff" /> 	<path d="M -6,0.5 h 12" style="fill:none; stroke-width:3; stroke:#ac00ff" /> </g> </svg> ',
    # 87 https://upload.wikimedia.org/wikipedia/commons/f/f9/Symbol_code_ww_87.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 87 	Description: Shower(s) of snow pellets or small hail, slight with or without rain or rain and snow mixed </desc> <g id="ww_87"> 	<path d="M -6,-8.5 h 12 l -6,-10.4 z" style="fill:none; stroke-width:3; stroke:#000000" /> 	<path d="M 0,-2.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#00d700" /> </g> </svg> ',
    # 88 https://upload.wikimedia.org/wikipedia/commons/7/7d/Symbol_code_ww_88.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 88 	Description: Shower(s) of snow pellets or small hail, moderate or heavy with or without rain or rain and snow mixed </desc> <g id="ww_88"> 	<path d="M -6,-8.5 h 12 l -6,-10.4 z" style="fill:none; stroke-width:3; stroke:#000000" /> 	<path d="M 0,-2.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#00d700" /> 	<path d="M -6,3.5 h 12" style="fill:none; stroke-width:3; stroke:#00d700" /> </g> </svg> ',
    # 89 https://upload.wikimedia.org/wikipedia/commons/a/af/Symbol_code_ww_89.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 89 	Description: Shower(s) of hail, with or without rain or rain and snow mixed, not associated with thunder, slight </desc> <g id="ww_89"> 	<path d="M -6,-8.5 h 12 l -6,-10.4 z" style="fill:#000000; stroke-width:3; stroke:#000000" /> 	<path d="M 0,-2.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#00d700" /> </g> </svg> ',
    # 90 https://upload.wikimedia.org/wikipedia/commons/d/d9/Symbol_code_ww_90.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 90 	Description: Shower(s) of hail, with or without rain or rain and snow mixed, not associated with thunder, moderate or heavy </desc> <g id="ww_90"> 	<path d="M -6,-8.5 h 12 l -6,-10.4 z" style="fill:#000000; stroke-width:3; stroke:#000000" /> 	<path d="M 0,-2.5 h 8.5 l-8.5,20 l-8.5,-20 z" style="fill:none; stroke-width:3; stroke:#00d700" /> 	<path d="M -6,3.5 h 12" style="fill:none; stroke-width:3; stroke:#00d700" /> </g> </svg> ',
    # 91 https://upload.wikimedia.org/wikipedia/commons/2/2c/Symbol_code_ww_91.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 91 	Description: Thunderstorm during the preceeding hour but not at time of observation with slight rain at time of observation </desc> <g id="ww_91"> 	<circle r="4.5" cx="17.5" cy="0" fill="#00d700" /> 	<path d="M -22.5,-17.5 h 24 l-14,19.5 l 14.5,14.5" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M -18.5,-17.5 v 37" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M 1.5,-23 h 7 v 46 h-7" style="fill:none; stroke-width:3; stroke:#000000" /> 	<path d="M 1,16.5 h1 v-1 z" style="fill:#ed1c24; stroke-width:3; stroke:#ed1c24" /> </g> </svg> ',
    # 92 https://upload.wikimedia.org/wikipedia/commons/4/49/Symbol_code_ww_92.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 92 	Description: Thunderstorm during the preceeding hour but not at time of observation with moderate or heavy rain at time of observation </desc> <g id="ww_92"> 	<circle r="4.5" cx="17.5" cy="-6" fill="#00d700" /> 	<circle r="4.5" cx="17.5" cy="6" fill="#00d700" /> 	<path d="M -22.5,-17.5 h 24 l-14,19.5 l 14.5,14.5" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M -18.5,-17.5 v 37" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M 1.5,-23 h 7 v 46 h-7" style="fill:none; stroke-width:3; stroke:#000000" /> 	<path d="M 1,16.5 h1 v-1 z" style="fill:#ed1c24; stroke-width:3; stroke:#ed1c24" /> </g> </svg> ',
    # 93 https://upload.wikimedia.org/wikipedia/commons/6/6b/Symbol_code_ww_93.svg
    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 93 	Description:  </desc> <g id="ww_93"> <g transform="translate(17.5,0)"> 	<path id="ww93arm" d="M -5.5,0 h 11" stroke="#ac00ff" stroke-linecap="round" stroke-width="3" /> 	<use xlink:href="#ww93arm" transform="rotate(60)" /> 	<use xlink:href="#ww93arm" transform="rotate(120)" /> </g> 	<path d="M -24.5,-17.5 h 24 l-14,19.5 l 14.5,14.5" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M -20.5,-17.5 v 37" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M -0.5,-23 h 7 v 46 h-7" style="fill:none; stroke-width:3; stroke:#000000" /> 	<path d="M -1,16.5 h1 v-1 z" style="fill:#ed1c24; stroke-width:3; stroke:#ed1c24" /> </g> </svg> ',
    # 94 https://upload.wikimedia.org/wikipedia/commons/0/05/Symbol_code_ww_94.svg
    '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 94 	Description: Thunderstorm during the preceeding hour but not at time of observation with moderate or heavy snow, or rain and snow mixed, or hail at time of observation </desc> <g id="ww_94"> <g id="ww_70_in_94" transform="translate(17.5,7.5)"> 	<path id="ww94arm" d="M -5.5,0 h 11" stroke="#ac00ff" stroke-linecap="round" stroke-width="3" /> 	<use xlink:href="#ww94arm" transform="rotate(60)" /> 	<use xlink:href="#ww94arm" transform="rotate(120)" /> </g> 	<use xlink:href="#ww_70_in_94" transform="translate(0,-15)" /> 	<path d="M -24.5,-17.5 h 24 l-14,19.5 l 14.5,14.5" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M -20.5,-17.5 v 37" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M -0.5,-23 h 7 v 46 h-7" style="fill:none; stroke-width:3; stroke:#000000" /> 	<path d="M -1,16.5 h1 v-1 z" style="fill:#ed1c24; stroke-width:3; stroke:#ed1c24" /> </g> </svg> ',
    # 95 https://upload.wikimedia.org/wikipedia/commons/8/80/Symbol_code_ww_95.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 95 	Description: Thunderstorm, slight or moderate, without hail but with rain and or snow at time of observation </desc> <g id="ww_95"> 	<circle r="4.5" cx="0" cy="-19" fill="#00d700" /> 	<path d="M -10.5,-10 h 20 l-11.5,16.5 l 12,12" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M -6.5,-10 v 31.5" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M 9,18.5 h1 v-1 z" style="fill:#ed1c24; stroke-width:3; stroke:#ed1c24" /> </g> </svg> ',
    # 96 https://upload.wikimedia.org/wikipedia/commons/c/cd/Symbol_code_ww_96.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 96 	Description: Thunderstorm, slight or moderate, with hail at time of observation </desc> <g id="ww_96"> 	<path d="M -4,-14 h 8 l -4,-6.93 z" style="fill:none; stroke-width:2.5; stroke:#000000" /> 	<path d="M -10.5,-8 h 20 l-11.5,16.5 l 12,12" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M -6.5,-8 v 31.5" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M 9,20.5 h1 v-1 z" style="fill:#ed1c24; stroke-width:3; stroke:#ed1c24" /> </g> </svg> ',
    # 97 https://upload.wikimedia.org/wikipedia/commons/f/fb/Symbol_code_ww_97.svg
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <desc id="en"> 	Codes 80-99 General Group: Showery precipitation, or precipitation with current or recent thunderstorm. 	Code: 97 	Description: Thunderstorm, heavy, without hail but with rain and or snow at time of observation </desc> <g id="ww_97"> 	<circle r="4.5" cx="0" cy="-19" fill="#00d700" /> 	<path d="M -10.5,-10 h 20 l-7.5,14.5 l 6.5,6.5 l-6.5,6.5" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M -6.5,-10 v 31.5" style="fill:none; stroke-width:3; stroke:#ed1c24" /> 	<path d="M 2,18.5 h-1 v-1 z" style="fill:#ed1c24; stroke-width:3; stroke:#ed1c24" /> </g> </svg> ',
...
WAWA_SYMBOLS = [
    ...
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <path fill="none" stroke-width="3" stroke="#000000" d="M 0,0 a 34,17.705691893392046 0 0 0 9,-12 a 9,9 0 0 0 -18,0 a 34,17.705691893392046 0 0 0 9,12 a 34,17.705691893392046 0 0 1 9,12 a 9,9 0 0 1 -18,0 a 34,17.705691893392046 0 0 1 9,-12" /> </svg>',
    # 05 Haze or smoke, or dust in suspension in the air, visibility less than 1 km
    '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="55" height="55" viewBox="-27.5 -27.5 55 55"> <path fill="none" stroke-width="3" stroke="#000000"  d="M 0,0 a 34,17.705691893392046 0 0 0 9,-12 a 9,9 0 0 0 -18,0 a 34,17.705691893392046 0 0 0 9,12 a 34,17.705691893392046 0 0 1 9,12 a 9,9 0 0 1 -18,0 a 34,17.705691893392046 0 0 1 9,-12" /> <path fill="#000000" d="M 0,0 a 34,17.705691893392046 0 0 1 9,12 a 9,9 0 0 1 -18,0 a 34,17.705691893392046 0 0 1 9,-12 z" /> </svg>',
    # 06...09 reserved
    None,None,None,None,
    # 10 Mist
    WW_SYMBOLS[10],
    ...
    if wwcode[0]<=3 or (wwcode[0]>=20 and wwcode[0]<30):
        ...
        if cover is not None:
            ...
            try:
                ...
                n_str = str(n)
            wwcode = (wwcode[0],wwcode[1]+' '+n_str,wwcode[2]+' '+str(n),wwcode[3],icon,dwd,aeicon,aecode,WW_SYMBOLS[wwcode[0]])
    return wwcode
...
def print_ww_list(image_path='.'):
    ...
    for ww in x:
        ...
        s += '    <td>'
        if ww[4]:
            s += '<img src="%s" width="55" alt="%s" />' % (ww[4],ww[1])
        s += '</td>\n'
        s += '    <td>'+ww[1]+'</td>\n'
        s += '  </tr>\n'
    s += '</table>\n'
